...
#[allow(dead_code)]
impl Quote {
    tdx_body_field!(report_data);
    tdx_body_field!(mr_config_id);
    tdx_body_field!(rtmr_0);
    tdx_body_field!(rtmr_1);
    tdx_body_field!(rtmr_2);
    tdx_body_field!(rtmr_3);
    tdx_body_field!(td_attributes);
